...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.ValidateMLTokenRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/handlers.ValidateMLTokenResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request - Invalid input",
    ...
    "definitions": {
        ...
        "handlers.ValidateMLTokenRequest": {
            "type": "object",
            "required": [
                "token"
            ],
        ...
        "handlers.ValidateMLTokenResponse": {
            "type": "object",
            "properties": {
                "is_valid": {
                    "type": "boolean",
